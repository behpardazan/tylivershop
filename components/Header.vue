    ...
    <div class="container lg:flex-row-reverse flex items-center p-1 dark: text-black">
      ...
      >
        <svg
          ...
          data-v-inspector="components/Header.vue:115:11"
          data-v-a81738bd=""
        >
          <path
      ...
      >
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          data-v-inspector="components/Header.vue:70:11"
          data-v-a81738bd=""
        >
          <path
