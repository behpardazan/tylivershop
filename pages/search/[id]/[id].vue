<template>
  <section class="product-inner">
    ...
    <div class="container p-2 flex flex-wrap">
      ...
      <div class="image-box w-full lg:w-1/3 border rounded mt-1 flex justify-center">
      ...
      <div class="info-box lg:w-1/3 w-full p-1">
        ...
        <div class="saleBox bg-yellow-500 p-3 mt-4 rounded-lg">
          <div class="finalPrice text-sm flex items-center justify-between">
            ...
            <span>{{ (data?.data?.price * count)?.toLocaleString() }}
          ...
          <div class="counBox p-2 bg-yellow-300 rounded mt-3 flex items-center justify-between">
            ...
            <button @click="count++"
              class="bg-black p-2 rounded-full w-[30px] h-[30px] text-white text-xl flex items-center justify-center">+</button>
            <span>{{ count }}</span>
            <button @click="count--"
              class="bg-black p-2 rounded-full w-[30px] h-[30px] text-white text-xl flex items-center justify-center">-</button>
          ...
          <button class="bg-green-600 hover:bg-green-700 rounded p-2 mt-2 text-white w-full">{{ $t('add2basket')
            }}</button>
        </div>
      </div>
