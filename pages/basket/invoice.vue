    ...
    <section class="invoice pذ-4 bg-white dark:text-black">
      ...
      },
      {
        ...
        <div class="container p-1">
            ...
            <div class="shiping text-sm p-1 w-1/3">

                <div class="delivery flex w-full">
                    <div class="lg:w-3/6 text-center border flex items-center justify-start ps-5  p-1">
                    ...
                    <div class="lg:w-3/6 text-center border   p-1">
                    {{ item?.count }}</div>
            ...
            <div class="factor border mt-2 rounded">
                <div class="factor-header flex w-full">
                    <div class="lg:w-1/12 text-center border bg-gray-200 p-1">ردیف</div>
                    <div class="lg:w-5/12 text-center border bg-gray-200 p-1">شرح</div>
                    <div class="lg:w-1/6 text-center border bg-gray-200 p-1">فی</div>
                    <div class="lg:w-1/6 text-center border bg-gray-200 p-1">تعداد</div>
                    <div class="lg:w-1/6 text-center border bg-gray-200 p-1">قیمت</div>
                </div>
          ...
          <BasketMerchant />
          <div class="btn-box w-full flex">
          <p><input @change="acceptRule=!acceptRule" 
          :checked="acceptRule==true" type="checkbox">
            <NuxtLink class="text-blue-700">قوانین و مقررات</NuxtLink>
            را خوانده ام و می پذیرم.
          </p>{{ acceptRule }}
            <button class="bg-green-500 hover:bg-green-600 flex items-center p-1 rounded px-3 text-green-900 mt-2 ms-auto">
