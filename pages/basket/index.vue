<template>
    <section class="basket py-3 bg-gray-100 min-h-[600px]">
        <div class="container p-1 flex flex-wrap">
            ...
            <div class="cartItems p-1 border w-3/4 bg-white mt-1">
            ...
            <div class="w-1/4 p-1">
                ...
                <button class="bg-yellow-500 hover:bg-yellow-600 mt-auto p-1 rounded w-full flex items-center justify-center">ادامه
